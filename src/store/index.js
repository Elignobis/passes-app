...
export default createStore({
  state: {
    players: [
      {id: 1, img_URL:'https://i.postimg.cc/8PBwf5kL/christiano.jpg', name: 'Cristiano Ronaldo', age:'37', gender: 'Male', currrentClub: 'Manchester United F.C.', nationalTeam: 'Portugal', price: 100},
